...
<SendCard@MDCard>:
    id: stubborn_layout
    size_hint_y: None
    height: lbl.height # Bind to Label height to update according to font size, for exampl
    MDLabel:
    	id: lbl # Add id for referencing in stubborn_layout
    	text:"Hi"
    	size_hint_y: None
    	size: self.texture_size
    	font_size: 20 # Try different font sizes. stubborn_layout will update accordingly
    	padding_x: 6
    	padding_y: 6
"""
...
class HomeScreen(Screen):
    ...
    def send_msg(self,msg_data):
        ...
        text_msg = MDLabel(text='''tdflu''',halign="left",)
        ...
        msg_card= MDCard(
            orientation= "vertical",
            size_hint=[None,None],
            size=[sizeX,text_msg.texture.size[1]/2],
            spacing=8,
            padding=20,
            elevation=9,
        ...
        card_inst = Factory.SendCard()
        card_inst.ids.lbl.text="ihbjjjjjjjjsssssssssssssssssssssssssssssssssssssssssssjhauihduiahdyiadnoijahydihjacbiaoikljyugijkjhgtyguijkhbgftgyuhjnbhvgfgyuhijnbhgfcytuijhgcfyuihjbgyuijkbvcfgtyuihjbgftyuhjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj"
        self.ids.all_msgs.add_widget(card_inst)
